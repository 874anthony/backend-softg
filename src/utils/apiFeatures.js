...
class APIFeatures {
    ...
    filter() {
        ...
        /*
            ...
            */
        const queryObject = Object.assign({}, this.queryParams);
        ...
        queryString = queryString.replace(/\b(gte|gt|lte|lt)\b/g, (matchedOperator) => `$${matchedOperator}`);
    ...
    limitFields() {
        ...
        if (this.queryParams.fields) {
            // Cast to string to bypass TypeScript problem
            const fieldBy = this.queryParams.fields.split(',').join(' ');
    ...
    paginate() {
        ...
        const page = parseInt(this.queryParams.page) * 1 || 1;
        const limit = parseInt(this.queryParams.limit) * 1 || 100;

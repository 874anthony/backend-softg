...
// Model
const routes_model_1 = __importDefault(require("@models/routes/routes.model"));
// General controller
...
const populateRouteOptions = [
    { path: 'driverId', select: 'firstName' },
    { path: 'vehicleId', select: 'description year' },
];
const getRoute = factory.findOne(routes_model_1.default, populateRouteOptions);
